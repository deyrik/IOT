...
- Entendimento de modo Economico (baixo custo energitico no loop)
- Interrupções e chamadas de  sistemas. 
- Concexão entre módulos (placas distintas)
- WIFI , Bluetooth
- Requisições e passagens de dados usando hardware e comunição wifi e bluetooth
